import {create_html, switch_screens, create_modal, create_input, remove_modal} from './utility.js';
...
function display_sidebar(){
  ...
  const create_project_link = create_html('a', 'sidebar-create-project', 'Create a Project');
...
function create_project(){
  ...
  const form_title = create_input('text', 'create-project-title', 'Project Title:');
